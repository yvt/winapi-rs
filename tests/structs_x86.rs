...
fn um_gdipluseffects() {
    ...
    assert_eq!(size_of::<RedEyeCorrectionParams>(), 8);
    assert_eq!(align_of::<RedEyeCorrectionParams>(), 4);
...
fn um_gdiplusimaging() {
    ...
    assert_eq!(size_of::<ImageCodecInfo>(), 76);
    assert_eq!(align_of::<ImageCodecInfo>(), 4);
    assert_eq!(size_of::<BitmapData>(), 24);
    assert_eq!(align_of::<BitmapData>(), 4);
    assert_eq!(size_of::<EncoderParameter>(), 28);
    assert_eq!(align_of::<EncoderParameter>(), 4);
    assert_eq!(size_of::<EncoderParameters>(), 32);
    assert_eq!(align_of::<EncoderParameters>(), 4);
    assert_eq!(size_of::<ImageItemData>(), 28);
    assert_eq!(align_of::<ImageItemData>(), 4);
    assert_eq!(size_of::<PropertyItem>(), 16);
    assert_eq!(align_of::<PropertyItem>(), 4);
}
#[cfg(feature = "gdiplusinit")] #[test]
fn um_gdiplusinit() {
    use winapi::um::gdiplusinit::*;
    assert_eq!(size_of::<GdiplusStartupInput>(), 16);
    assert_eq!(align_of::<GdiplusStartupInput>(), 4);
    assert_eq!(size_of::<GdiplusStartupInputEx>(), 20);
    assert_eq!(align_of::<GdiplusStartupInputEx>(), 4);
    assert_eq!(size_of::<GdiplusStartupOutput>(), 8);
    assert_eq!(align_of::<GdiplusStartupOutput>(), 4);
}
